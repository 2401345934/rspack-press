...
(function() {
var map = {"./docs/guide/index.md": ["857",],"./docs/hello.md": ["828",],"./docs/index.md": ["925",],};
...
// This function allow to reference chunks
        __webpack_require__.u = function (chunkId) {
          ...
          return {"828": "static/js/async/828.js","857": "static/js/async/857.js","925": "static/js/async/925.js",}[chunkId];
        };
...
// This function allow to reference chunks
        __webpack_require__.k = function (chunkId) {
          // return url for filenames based on template
          return {"327": "static/css/327.css",}[chunkId];
        };
...
__webpack_require__.f.j = function (chunkId, promises) {
	...
	if (installedChunkData !== 0) {
		...
		if (installedChunkData) {
			...
			if (['327','828','857','925','lib-lodash','lib-polyfill','lib-react','lib-router','main'].indexOf(chunkId) > - 1) {
				// setup Promise in chunk cache
				var promise = new Promise(function (resolve, reject) {
					installedChunkData = installedChunks[chunkId] = [resolve, reject];
				});
